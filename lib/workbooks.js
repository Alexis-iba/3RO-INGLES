// Twenty teaching pages per book. Content is specific to each topic.
...
export const WORKBOOK_PAGES = [
  ...
  ['Let’s Review', 'Work on your own. Then check your progress.', 'Trabaja por tu cuenta y revisa tu progreso.'],
  ['Read Together', 'Read the story. Use the pictures and word help.', 'Lee la historia. Apóyate en las imágenes y el vocabulario.'],
  ['Read and Choose', 'Choose one answer for each question.', 'Elige una respuesta para cada pregunta.'],
  ['Join with Lines', 'Match each picture to its English word.', 'Une cada imagen con su palabra en inglés.'],
  ['More Connections', 'Match the remaining pictures and words.', 'Une las demás imágenes con sus palabras.'],
  ['Another Story', 'Read slowly. Picture what happens in your mind.', 'Lee despacio e imagina lo que sucede.'],
  ['Story Questions', 'Read the story again. Choose the correct answer.', 'Vuelve a leer la historia. Selecciona la respuesta correcta.'],
  ['First, Next, Last', 'Write 1, 2 or 3 to put the story in order.', 'Escribe 1, 2 o 3 para ordenar la historia.'],
  ['Complete the Story', 'Complete each sentence. Use each word once.', 'Completa cada oración. Usa cada palabra una vez.'],
  ['Picture Explorer', 'Look carefully. Name something in each picture.', 'Observa con atención. Nombra algo de cada imagen.'],
  ['My Picture Words', 'Look, say and write. Use the dictionary for help.', 'Observa, di y escribe. Apóyate en el diccionario.']
];
